...
const HeroSection = () => {
  return (
    <div className="relative h-auto md:h-[40rem] w-full flex flex-col items-center justify-center overflow-hidden mx-auto py-10 md:py-0 bg-gradient-to-br from-gray-800 to-black"> {/* Updated gradient to match the footer */}
